...
| 10  | ソート機能         | ユーザー一覧、アイテム一覧、マイアイテム一覧では一部項目による昇順/降順ソートが可能。<br>検索条件がある場合は検索結果を引き継いでソート（Ajax）。 |
...
## ER図
![intelist_er_rev2](https://user-images.githubusercontent.com/61620946/135751149-e98527d3-d764-4ce6-9231-0ccd258e9683.jpg)
